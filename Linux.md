...
<ol>
<li>1.Updating linux system</li>
<li> i.sudo apt update</li>
<li> ii.sudo apt full-upgrade -y</li>
<li>iii.sudo apt dist-upgrade -y</li>
<li> iv.sudo apt autoremove</li>

<li>2.Checking the user</li>
  <li>i.whoami</li>

<li>3.Creating bash scripting</li>
  <li>i.#! /bin/bash</li>
<li>Note: After shebang then below it you add all your scripts you want to run then save the file.
      Then make sure you use chmod or just on the gui to give wxwcute permission to run the script.</li>

<li>4.Change or grant permission</li>
  <li>i.chmod +x or -X say for give execution power or take away execution</li>

<li>5.Elevate yourself to root</li>
 <li>i.sudo su</li>

<li>6.Making Directory/navigation</li>
  <li>i. mkdir name</li>
  <li>ii.pwd # display the current directory</li>
  <li>iii.cd # change directory</li>

<li>7.Creating/readinf a file</li>
  <li>i.touch name</li>
  <li>ii. nano name</li>
  <li>iii. cat name</li>

<li>8.Managing Files</li>
...
<li>10.system monitoring</li>
  <li>i.top</li>
  <li>ii.kill -process id number-</li>

<li>11.System Management</li>
